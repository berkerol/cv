...
\end{tabular}
\hspace{1.4cm} {\Huge \textbf{BERK EROL}} \hspace{2.5cm}
\begin{tabular}{r l}
...
\begin{tabular}{r p{15.7cm}}
	...
	Sep. 2014 & \textbullet\ GPA: 3.18/4.00 \hspace{0.4em} Senior Project: Identity System for Blockchain (Solidity, Node.js, MongoDB, Docker)\\
...
\section{EXPERIENCE}
\begin{tabular}{r p{15.7cm}}
	Present & \textbf{Backend Engineer} \hspace{1em} Armut / HomeRun \hfill Istanbul, Turkey\\
	Jan. 2019 & \textbullet\ Improved the notification system for maintainability, new business rules and regulations using C\#.\\\\
