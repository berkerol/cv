...
\usepackage{geometry}
\geometry{a4paper, left = 14mm, right = 14mm, top = 26mm, bottom = 26mm}
...
\section{EXPERIENCE}
\begin{tabular}{r p{15.7cm}}
	Present & \textbf{Infrastructure Engineer} \hspace{1em} Armut / HomeRun \hfill Istanbul, Turkey\\
...
\begin{tabular}{r p{15.4cm}}
	...
	& MySQL, MongoDB, Elasticsearch (ELK), Unix \& Linux, Docker, Jenkins, Terraform\\\\
