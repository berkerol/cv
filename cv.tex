...
\usepackage{geometry}
\geometry{a4paper, left = 14mm, right = 14mm, top = 21mm, bottom = 21mm}
...
\begin{tabular}{r p{15.4cm}}
    ...
    \textbf{Familiar} & Prolog, Unix \& Linux, Git\\\\
...
\begin{itemize}
    ...
    \item \textbf{Come Together'CMPE, Bogazici University (Nov. 2015)}\\
        Met and networked with alumni and learned job opportunities.
