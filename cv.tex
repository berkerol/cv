...
\end{tabular}
\hspace{1.4cm} {\Huge \textbf{BERK EROL}} \hspace{1.6cm}
\begin{tabular}{r l}
...
\begin{tabular}{r p{15.7cm}}
	June 2019 & \textbf{B.S. in Computer Engineering} \hspace{1em} Bogazici University \hfill Istanbul, Turkey\\
	Sep. 2014 & \textbullet\ Current GPA: 3.14/4.00 Comp. Eng. Avg.: 3.35/4.00\\
	& \textbullet\ Highest Grades: Analysis of Algorithms, Data Str. \& Algorithms, Systems Prog., OS, Prob. \& Statistics\\\\
	Aug. 2018 & \textbf{Erasmus Study in Informatics} \hspace{1em} Technical University of Munich \hfill Munich, Germany\\
	Apr. 2018 & \textbullet\ Courses: Social Gaming, Testing, Security Eng., Project Org. \& Mgmt. in SWE, Aug. Reality, 3D UIs
\end{tabular}

\section{EXPERIENCE}
\begin{tabular}{r p{15.7cm}}
	Mar. 2018 & \textbf{Backend Engineer Intern} \hspace{1em} Carla Car Rental \hfill Istanbul, Turkey\\
	Jan. 2018 & \textbullet\ Made car search 1.5x faster by improving API requests, filters and sorts using Java 8 and Spring.\\
	...
	Aug. 2017 & \textbf{Software Engineer Intern} \hspace{1em} OBSS \hfill Istanbul, Turkey\\
	July 2017 & \textbullet\ Got the 2\textsuperscript{nd} place and won a prize in the contest by building a recruitment website from scratch\\
	...
	June 2017 & \textbf{Software Engineer Intern} \hspace{1em} Khan Academy TR \hfill Istanbul, Turkey\\
	...
	Jan. 2018 & \textbf{Student Ambassador} \hspace{1em} IBM \hfill Istanbul, Turkey\\
	Mar. 2017 & \textbullet\ Attended meetings, seminars, trainings and workshops to learn IBM technologies.\\\\
	Jan. 2016 & \textbf{Student Teaching Assistant} \hspace{1em} Bogazici University \hfill Istanbul, Turkey\\
	Oct. 2015 & \textbullet\ Taught freshmen algorithms, data structures, sorting and searching in C.
\end{tabular}

\section{SKILLS}
{\renewcommand{\arraystretch}{0.7}
\begin{tabular}{r p{15.4cm}}
	\textbf{Proficient} & Java 8 (Spring Boot), JavaScript (ES6+), Git, REST APIs\\\\
	\textbf{Familiar} & Python, C\#, C, C++, Solidity, HTML5, CSS3, MySQL, Elasticsearch (ELK), Unix \& Linux, Docker, AWS\\\\
